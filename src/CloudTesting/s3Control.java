...
public class s3Control {
    ...
    private static void PutFile(String bucketName, String fileName, File file, AmazonS3 client){

        client.putObject(new PutObjectRequest(bucketName, fileName, file).withCannedAcl(CannedAccessControlList.PublicReadWrite));
    }

    private static File GetFile(String bucketName, String fileName, AmazonS3 client) throws IOException {
