...
//        // create Session from Video, there are 3 constructor for Session, two for making from only certain segment (not all)
//
//        //Settings newRequest = new Settings(userRequest.videoname, userRequest.resHeight, userRequest.resWidth);
//
//        Session ST=new Session(CVSE.VR.videos.get(videoIndex),userRequest); //admission control can work in constructor, or later?
//
...
//
//        System.out.println("Number of Session GOPs in stream: " + ST.streamGOPs.size());
//        //Scheduler
//        System.out.println("before stream");
//        GTS.addStream(ST);
