...
public class TimeEstimator {
    ...
    public static void updateTable(int id,HashMap<Integer, Tuple<Long,Integer>> runtime_report){
        Table.replace(id,runtime_report);
    ...
    public static long getHistoricProcessTime(int id,StreamGOP segment){
        HashMap<Integer, Tuple<Long,Integer>> polled1=Table.get(segment.userSetting.settingIdentifier);
        if(polled1!=null){
        ...
        System.out.println("No historic data!");
        return 500; //set at arbitary nonzero value
    }
